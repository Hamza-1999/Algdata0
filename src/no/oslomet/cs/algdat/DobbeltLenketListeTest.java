...
class DobbeltLenketListeTest {
    ...
    void oppgave1() {
        int antallFeil = 0;
        no.oslomet.cs.algdat.Liste<Integer> liste = new DobbeltLenketListe<>();
    ...
    void oppgave3() {
        ...
        no.oslomet.cs.algdat.Liste<Integer> testliste = new DobbeltLenketListe<>();
    ...
    void oppgave6() {
        ...
        no.oslomet.cs.algdat.Liste<Integer> nyliste = new DobbeltLenketListe<>();
